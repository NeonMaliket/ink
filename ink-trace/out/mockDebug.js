...
class MockDebugSession extends debugadapter_1.LoggingDebugSession {
    ...
    _configurationDone = new await_notify_1.Subject();
    ...
    convertFromRuntime(v) {
        ...
        if (v.name.indexOf('lazy') >= 0) {
            ...
            v.reference ??= this._variableHandles.create(new mockRuntime_1.RuntimeVariable('', [new mockRuntime_1.RuntimeVariable('', v.value)]));
